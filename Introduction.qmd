...
*Difference/Relative complement* : these are elements in the set $𝑆$ BUT NOT in $𝑇$ where
$$S−𝑇=𝑆∩𝑇̅ =\{𝑎,𝑐\}$$
There are also addition, subtraction and multiplication for sets.
